...
export function initDB() {
  ...
  // If news table exists but 0002 seed hasn't been recorded,
  ...
  const seed002Applied = database.prepare(
    "SELECT name FROM schema_migrations WHERE name = '0002_seed_data.sql'"
  ).get();
  if (newsExists && !seed002Applied) {
